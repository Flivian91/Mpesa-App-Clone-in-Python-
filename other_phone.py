...
class OtherPhone():
    def __init__(self, root):
        ...
        # Other phone Buy Airtime Option on Top
        ...
        # Enter Phone No  Button
        phone_btn = CTkButton(self.root,command=self.phone_no, text="Enter Phone No",text_color="black",width=360,border_width=0,corner_radius=0,
         fg_color="white", bg_color="white", font=("Bookman old Style", 17), hover_color="light gray", anchor=W, height=42)
        phone_btn.place(x=0, y=180)
